...
int main() {
    int numRows, numCols;
    float** data = readFloatsFromFile("/home/chku/treebeard/llvm-project/mlir/examples/treebeard/xgb_models/letters_xgb_model_save.json.test.sampled.csv", &numRows, &numCols);
